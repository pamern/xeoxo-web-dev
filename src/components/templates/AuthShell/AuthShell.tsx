  ...
  return (
    ...
    >
      <div className="px-5 pb-7 pt-9 sm:px-8 sm:pb-9 sm:pt-12 md:px-[56px] md:pb-11 md:pt-[54px]">
        ...
        <h1 className="mt-3 max-w-form text-[34px] font-extrabold leading-[1.08] tracking-[-0.03em] text-foreground sm:text-[40px] md:text-[44px]">
...
function SocialButton({
  ...
  return (
    <button
      ...
      aria-label={label}
      onClick={onClick}
      className="flex h-[64px] w-[64px] items-center justify-center rounded-md border border-[#DB7A6A] bg-background transition-colors hover:bg-muted"
    >
