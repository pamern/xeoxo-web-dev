...
export function CancelOrderButton({ orderId, orderCode }: CancelOrderButtonProps) {
  ...
  async function handleCancelOrder() {
    ...
    try {
      ...
      // Success - close modal and reload page data
      setIsOpen(false);
      router.refresh();
    } catch (err) {
        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center px-4">
          ...
          <div className="relative z-10 w-full max-w-[440px] border-2 border-black bg-white p-[30px] shadow-[0_20px_50px_rgba(0,0,0,0.15)]">
            ...
            <p className="mt-4 text-center text-sm font-light leading-relaxed text-black/75">
              Bạn có chắc chắn muốn hủy đơn hàng <strong className="font-semibold text-black">{orderCode}</strong>? Hành động này không thể hoàn tác.
            </p>
            ...
            <div className="mt-8 flex flex-col sm:flex-row gap-3">
              <button
                ...
                className="flex-1 flex min-h-[44px] items-center justify-center rounded-pill bg-[#ff593d] text-[14px] font-bold uppercase text-white transition-colors hover:bg-[#e0482c] disabled:opacity-50"
              >
              ...
              <button
                ...
                className="flex-1 flex min-h-[44px] items-center justify-center rounded-pill border-2 border-black bg-white text-[14px] font-bold uppercase text-black transition-colors hover:bg-black/5 disabled:opacity-50"
              >
                Quay lại
              </button>
            </div>
