      ...
      <div className="flex flex-col gap-6">
        <div>
          ...
          <div className="mt-2 flex flex-wrap items-center gap-3">
            <span className="text-[44px] font-bold leading-none">{avgRating}</span>
          ...
          filteredReviews.map((review) => (
            ...
            >
              <div className="flex gap-4">
                <div className="relative h-12 w-12 shrink-0 overflow-hidden rounded-full bg-secondary flex items-center justify-center font-bold text-lg text-foreground/75 border border-foreground/10">
