...
export function SizeGuideModal({ gender, onClose }: SizeGuideModalProps) {
  ...
  const closeIconSrc = "/icons/close-black.svg";
  ...
  return (
    ...
    >
      <div
        ...
        className="relative flex max-h-[92dvh] w-fit max-w-[95vw] items-center justify-center overflow-hidden"
      >
        <button
          type="button"
          onClick={onClose}
          aria-label="Đóng bảng kích thước"
          className="absolute right-3 top-3 z-10 flex h-11 w-11 items-center justify-center sm:right-5 sm:top-5"
        >
          <Image
            src={closeIconSrc}
            alt=""
