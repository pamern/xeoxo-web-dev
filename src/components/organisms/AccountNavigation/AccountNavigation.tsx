...
function AccountNavCard({
  ...
  const className = cn(
    variant === "account"
      ? "flex min-h-[46px] w-full items-center justify-between gap-2 rounded-md border-2 border-black px-3 py-2 text-left transition-colors md:min-h-[56px] md:gap-4 md:px-5 md:py-3"
