...
function AccountNavCard({
  ...
  const className = cn(
    variant === "account"
      ? "flex min-h-[36px] w-full items-center justify-between gap-2 rounded-md border-2 border-black px-3 py-1.5 text-left transition-colors md:min-h-[42px] md:gap-3 md:px-3.5 md:py-2"
  ...
  const content = (
    <>
      ...
      <Image
        ...
        className={cn(
          "h-auto shrink-0",
          variant === "account" ? "w-4 md:w-5" : "w-5",
