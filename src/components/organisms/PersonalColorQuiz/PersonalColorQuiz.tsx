        ...
        {currentQuestion.options.map((option) => (
          ...
          >
            <div className="flex flex-1 flex-col justify-center gap-2 px-8">
              <span className="text-heading-card">{option.key}.</span>
              <span className="text-body-lg font-medium">{option.text}</span>
            </div>
  ...
  return (
    <section className="relative w-full overflow-hidden bg-secondary/30 py-16">
      ...
      <div className="mx-auto w-full max-w-[720px] px-6 text-center xl:px-0">
        ...
        <h1 className="mt-5 text-display-section uppercase md:text-display-page">
          Personal Color là gì?
        </h1>
        <p className="mx-auto mt-4 max-w-[580px] text-body-lg text-muted-foreground">
        ...
        <div className="mt-10 rounded-lg border border-black/10 bg-background px-6 py-7 text-left shadow-sm md:px-10">
          <h2 className="text-center text-heading-card uppercase">
            Về bài quiz này
          </h2>
          <div className="mt-6 grid gap-6 md:grid-cols-3 md:gap-4">
            {QUIZ_STEPS.map((step, index) => (
              ...
              >
                ...
                <p className="whitespace-nowrap text-body-sm font-bold sm:text-body">
                  {step.title}
                </p>
...
function PersonalColorResult({
  ...
  return (
    <section className="mx-auto w-full max-w-site px-6 py-12 xl:px-gutter">
      <h1 className="text-center text-display-section uppercase md:text-display-page">
        Personal color của bạn là
      </h1>
      <p className="mt-2 text-center text-heading-section text-primary">
      ...
      {data && (
        <>
          <div className="mx-auto mt-8 max-w-[650px] text-center">
            <h2 className="text-heading-card uppercase">Màu sắc đề xuất</h2>
          ...
          {data.products.length > 0 && (
            <div className="mt-14">
              <h2 className="mb-6 text-heading-section uppercase">
                Có thể bạn sẽ thích
              </h2>
              <ProductGrid
