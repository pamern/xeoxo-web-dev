...
export default function CartPage() {
  return (
    <SiteLayout>
      <CheckoutProvider>
        <CartSummaryProvider>
          <section className="mx-auto grid w-full max-w-[1280px] gap-8 overflow-x-hidden px-3 py-5 sm:px-4 sm:py-8 md:px-6 lg:grid-cols-[minmax(0,1fr)_minmax(0,1.28fr)] lg:justify-center lg:gap-[30px] lg:overflow-visible lg:px-[60px] lg:py-[40px] xl:gap-[40px] xl:px-[100px]">
