...
export default function PolicyIndexPage() {
  return (
    <SiteLayout>
      <div className="mx-auto w-full max-w-site px-6 py-10 xl:px-gutter">
        ...
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          {POLICIES.map((policy) => (
            <Link
              ...
              className="rounded-md border border-border p-5 text-body-lg font-medium transition-colors hover:border-primary hover:text-primary"
            >
              {policy.title}
            </Link>
          ))}
