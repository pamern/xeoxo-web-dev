  ...
  theme: {
    extend: {
      ...
      fontSize: {
        ...
        nav: ["22px", { lineHeight: "1", letterSpacing: "0", fontWeight: "500" }],
        button: ["22px", { lineHeight: "1", letterSpacing: "0", fontWeight: "500" }],
        eyebrow: ["22px", { lineHeight: "1", letterSpacing: "0", fontWeight: "400" }],
        "body-lg": ["18px", { lineHeight: "1.35", letterSpacing: "0", fontWeight: "400" }],
        body: ["15px", { lineHeight: "1.6", letterSpacing: "0", fontWeight: "300" }],
        quote: ["15px", { lineHeight: "1.25", letterSpacing: "0", fontWeight: "300" }],
        "body-sm": ["13px", { lineHeight: "1.4", letterSpacing: "0", fontWeight: "300" }],
